...
simulate_two_partial_roc <- function(mean_signal_g1 = 1, mean_signal_g2 = 0.58,
  ...
  simulate_roc <- function() {
    if (!paired) {
      ...
      roc_g1 <- pROC::roc(labels_g1, ratings_g1, direction = "<", partial.auc = pauc, quiet = TRUE)
      roc_g2 <- pROC::roc(labels_g2, ratings_g2, direction = "<", partial.auc = pauc, quiet = TRUE)
      ...
      roc_g1 <- pROC::roc(labels, ratings_g1, direction = "<", partial.auc = pauc, quiet = TRUE)
      roc_g2 <- pROC::roc(labels, ratings_g2, direction = "<", partial.auc = pauc, quiet = TRUE)
