#' Simulate and Plot Paired ROC Curves for Two Groups
#'
#' This function simulates paired ROC data for two groups, generates confidence ratings,
#' computes ROC curves, and returns both the ROC objects and their plots.
#'
